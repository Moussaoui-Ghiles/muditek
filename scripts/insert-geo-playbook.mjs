// One-off: insert geo-playbook into content_items
...
const slug = "geo-playbook";
const title = "Cited, Not Ranked: The Complete GEO Playbook";
const description = "The complete Generative Engine Optimization playbook: make ChatGPT, Perplexity, Claude and Google AI Overviews find, read, and cite your content.";
...
const rows = await sql`
  ...
  VALUES
    (${title}, ${slug}, ${description}, 'playbook', 'geo',
