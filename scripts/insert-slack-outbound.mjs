// One-off: insert slack-outbound-agent-playbook into content_items
...
const slug = "slack-outbound-agent-playbook";
const title = "Run Your Entire Outbound From One Slack Channel";
const description = "The install path for a persistent-memory agent that runs outbound, marketing, sales intel, and content from one Slack channel. 45 verified leads from free data.";
