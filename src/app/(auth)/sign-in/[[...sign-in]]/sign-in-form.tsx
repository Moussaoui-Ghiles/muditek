...
export default function SignInForm() {
  return (
    <AuthShell variant="sign-in">
      <div className="mb-6">
        <h1 className="text-[24px] font-semibold tracking-[-0.01em] text-white">Sign in to Muditek</h1>
        <p className="mt-1.5 text-[13px] text-white/55">Welcome back. Access your portal, playbooks, and archive.</p>
      </div>
      <SignIn
        appearance={{
          elements: {
