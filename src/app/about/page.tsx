    ...
    <div className="bg-background min-h-[100dvh] text-foreground selection:bg-primary/20 flex flex-col items-center">
      ...
      <section className="pt-32 md:pt-44 pb-24 md:pb-32 w-full flex justify-center relative overflow-hidden">
        ...
        <div className="max-w-[1100px] w-full px-6 md:px-12 relative z-10">
          ...
          <ScrollReveal delay={80}>
            <h1 className="text-5xl sm:text-7xl lg:text-[80px] font-black tracking-[-0.04em] leading-[0.9] text-foreground mb-12 uppercase text-balance max-w-4xl">
          ...
          <ScrollReveal delay={160}>
            <p className="text-base md:text-lg text-foreground/50 font-light leading-relaxed max-w-2xl">
            ...
            {[
              ...
              <ScrollReveal key={step.num} delay={i * 100}>
                <div className="group relative h-full border border-white/[0.05] bg-card/[0.2] hover:bg-card/[0.5] backdrop-blur-md p-10 flex flex-col overflow-hidden transition-all duration-700 card-lift">
                  ...
                  <h4 className="text-xl font-black uppercase tracking-[0.05em] text-foreground mb-4">{step.title}</h4>
                  <p className="text-sm text-foreground/50 font-light leading-relaxed">{step.body}</p>
                </div>
              </ScrollReveal>
            ))}
          </div>
      ...
      <section className="py-32 md:py-40 w-full flex justify-center relative overflow-hidden bg-card/[0.15]">
        ...
        <div className="max-w-[1100px] w-full px-6 md:px-12 relative z-10">
          <ScrollReveal>
            ...
            <p className="text-base text-foreground/50 font-light leading-relaxed mb-16 max-w-xl">
            ...
            {PROOF_METRICS.map((row, i) => (
              <ScrollReveal key={row.label} delay={i * 60}>
                <div className={`group grid grid-cols-4 px-8 py-7 items-center stat-row cursor-default ${i < PROOF_METRICS.length - 1 ? "border-b border-white/[0.02]" : ""}`}>
                  ...
                  <div className="text-[12px] font-mono font-black tracking-widest text-primary/90 group-hover:text-primary">{row.after}</div>
                </div>
              </ScrollReveal>
            ))}
          </div>
        ...
        <div className="max-w-[1100px] w-full px-6 md:px-12 relative z-10">
          ...
          <ScrollReveal delay={400}>
            <div className="mt-12 border border-white/[0.05] bg-card/[0.2] p-8 rounded-[4px]">
              <h4 className="text-[10px] font-black uppercase tracking-[0.25em] text-foreground/40 mb-4">Differentiators</h4>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm text-foreground/50 font-light leading-relaxed">
      ...
      <section className="py-24 md:py-32 w-full flex justify-center border-t border-white/[0.02]">
        <div className="max-w-[1100px] w-full px-6 md:px-12">
          <ScrollReveal>
            <h2 className="text-[10px] font-black tracking-[0.3em] uppercase text-foreground/40 mb-8 flex items-center gap-3">
            ...
            <div className="flex flex-col md:flex-row md:items-start gap-8">
              <div>
                ...
                <p className="text-sm text-foreground/50 font-light leading-relaxed max-w-xl mb-4">
                  I build AI systems that run business operations. 35+ systems in production. $3M+ in revenue generated and saved for B2B companies. 35,000+ followers sharing what I build on LinkedIn.
                </p>
                <div className="flex items-center gap-4">
                  <a href="mailto:ghiles@muditek.com" className="text-[10px] font-mono text-primary/80 tracking-wider hover:text-primary transition-colors">ghiles@muditek.com</a>
                  <a href="https://www.linkedin.com/in/ghiles-moussaoui-b36218250/" target="_blank" rel="noopener noreferrer" className="text-[10px] font-mono text-foreground/40 tracking-wider hover:text-foreground transition-colors">LinkedIn</a>
                </div>
              </div>
            </div>
          </ScrollReveal>
