        ...
        <header className="relative overflow-hidden border-b border-white/[0.06] pb-20 pt-40 md:pb-28 md:pt-52">
          ...
          <div className="mx-auto grid w-full max-w-[1500px] gap-14 px-6 md:px-12 lg:grid-cols-[1fr_360px] lg:items-end">
            <div className="relative">
              <p className="flex items-center gap-3 text-[11px] font-black uppercase tracking-[0.24em] text-primary"><span className="h-px w-8 bg-primary" /> AI implementation</p>
              <h1 className="mt-7 max-w-[1000px] text-5xl font-black leading-[0.92] tracking-[-0.04em] sm:text-6xl md:text-[84px]">Build AI into a workflow your team <span className="font-medium italic text-primary">already owns.</span></h1>
              <p className="mt-8 max-w-[720px] text-base leading-8 text-foreground/75 md:text-lg">
                Start with the process, its owner, the source data, and the decisions people still need to review. The model and tools come after those constraints are clear.
              </p>
            </div>
            <aside className="border-y border-white/[0.12] py-6">
              <p className="text-[10px] font-black uppercase tracking-[0.2em] text-primary">A useful starting point</p>
              <p className="mt-4 text-sm leading-6 text-foreground/70">Bring one slow, error-prone, or fragmented workflow with a clear owner. We will determine whether AI is useful before deciding what to build.</p>
            </aside>
          </div>
        </header>
        ...
        <section className="border-b border-white/[0.06] py-24 md:py-32">
          <div className="mx-auto w-full max-w-[1500px] px-6 md:px-12">
            <div className="grid gap-12 lg:grid-cols-[0.65fr_1.35fr]">
              <div>
                <p className="text-[11px] font-black uppercase tracking-[0.2em] text-primary">How delivery works</p>
                <h2 className="mt-5 text-4xl font-black leading-none tracking-[-0.035em] md:text-5xl">Define it. Build it. Operate it.</h2>
              </div>
        ...
        <section id="applications" className="border-b border-white/[0.06] py-24 md:py-32">
          <div className="mx-auto w-full max-w-[1500px] px-6 md:px-12">
            <div className="max-w-3xl">
              <p className="text-[11px] font-black uppercase tracking-[0.2em] text-primary">Typical applications</p>
              <h2 className="mt-5 text-4xl font-black leading-none tracking-[-0.035em] md:text-6xl">Workflows we can scope.</h2>
              <p className="mt-6 text-base leading-7 text-foreground/70">These examples show the type of work. They are not presented as client results.</p>
            </div>
        ...
        <section className="py-24 md:py-32">
          <div className="mx-auto grid w-full max-w-[1200px] gap-10 px-6 md:grid-cols-[1fr_auto] md:items-end md:px-12">
            <div>
              ...
              <h2 className="mt-5 max-w-3xl text-4xl font-black leading-none tracking-[-0.035em] md:text-6xl">Bring one broken or slow workflow.</h2>
              <p className="mt-6 max-w-[680px] text-base leading-7 text-foreground/70">Be ready to show the current steps, the owner, available data, constraints, and the decision the workflow should improve.</p>
            </div>
