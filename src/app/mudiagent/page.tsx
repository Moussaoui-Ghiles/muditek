...
const FAQ = [
  { q: "We can build this ourselves with ChatGPT.", a: "ChatGPT can't read your WhatsApp, send emails, fill your CRM, or run at 6 am. It's a conversation tool — you type, it responds, and forgets everything. mudiAgent is a digital employee that executes real work on your infrastructure, autonomously, on schedule, and remembers everything." },
    ...
    <div className="bg-background min-h-[100dvh] text-foreground selection:bg-primary/20 flex flex-col items-center">
      ...
      <section className="pt-32 md:pt-44 pb-24 md:pb-32 w-full flex justify-center relative overflow-hidden">
        ...
        <div className="max-w-[1100px] w-full px-6 md:px-12 relative z-10">
          ...
          <ScrollReveal delay={160}>
            <div className="max-w-3xl space-y-6 text-base md:text-lg text-foreground/50 font-light leading-relaxed mb-6">
          ...
          <ScrollReveal delay={240}>
            <p className="text-sm text-foreground/30 italic max-w-2xl mb-14">
          ...
          <ScrollReveal delay={300}>
            <div className="flex flex-col sm:flex-row items-start gap-5">
              <Link href="#contact" className="group relative px-10 py-5 bg-foreground text-background font-black text-[11px] uppercase tracking-[0.2em] overflow-hidden rounded-[2px] hover:scale-[1.02] transition-transform duration-300 btn-press">
              ...
              <Link href="#transformation" className="px-8 py-5 border border-white/[0.1] text-foreground text-[11px] font-bold uppercase tracking-[0.2em] rounded-[2px] hover:bg-white/[0.02] transition-colors btn-press">
                See What Changes
              </Link>
            </div>
          </ScrollReveal>
      ...
      <section id="transformation" className="py-32 md:py-48 w-full flex justify-center relative border-t border-white/[0.02]">
        ...
        <div className="max-w-[1100px] w-full px-6 md:px-12 relative z-10">
          ...
          <ScrollReveal delay={80}>
            <div className="max-w-3xl space-y-4 text-base text-foreground/50 font-light leading-relaxed mb-16">
        ...
        <div className="max-w-[1100px] w-full px-6 md:px-12 relative z-10">
          <ScrollReveal>
            ...
            <p className="text-base text-foreground/40 font-light max-w-2xl mb-16">
              ChatGPT can&apos;t read your WhatsApp, send your emails, fill your CRM, or run at 6 am. It&apos;s a chatbox — you type, it responds, and forgets everything. mudiAgent is a digital employee that does the work.
            </p>
          </ScrollReveal>
            ...
            {CHATGPT_COMPARISON.map((row, i) => (
              <ScrollReveal key={row.category} delay={i * 60}>
                <div className={`group grid grid-cols-3 px-8 py-6 items-start stat-row cursor-default ${i < CHATGPT_COMPARISON.length - 1 ? "border-b border-white/[0.02]" : ""}`}>
                  <div className="text-[12px] font-bold tracking-[0.1em] uppercase text-foreground/60">{row.category}</div>
                  <div className="text-[11px] text-foreground/30 font-light leading-relaxed pr-4">{row.chatgpt}</div>
                  <div className="text-[11px] text-foreground/70 font-medium leading-relaxed">{row.mudiagent}</div>
                </div>
              </ScrollReveal>
            ))}
          </div>
              ...
              <div className="border border-red-500/[0.1] bg-red-500/[0.02] p-10 rounded-[4px]">
                ...
                <div className="space-y-5">
                  <div>
                    ...
                    <p className="text-[11px] text-foreground/40 font-light mt-1">20 hrs/week manual reporting × 52 weeks × 80% automatable</p>
                  </div>
                  <div>
                    <span className="text-2xl font-black text-foreground/80 font-mono">2,500+ hrs/year</span>
                    <p className="text-[11px] text-foreground/40 font-light mt-1">20 people × 5 searches/day × 30 min each. mudiAgent: 10 seconds.</p>
                  </div>
                  <div>
                    <span className="text-2xl font-black text-foreground/80 font-mono">€200K+/year</span>
                    <p className="text-[11px] text-foreground/40 font-light mt-1">That&apos;s 2-3 engineers&apos; salaries — spent on work a machine should do</p>
                  </div>
                </div>
              </div>
            </ScrollReveal>
            ...
            <div className="border border-white/[0.05] bg-card/[0.2] p-8 rounded-[4px]">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-[11px]">
                <div>
                  ...
                  <span className="text-foreground/30 font-light">$60/user/month × 50 users = $36,000/year. Still can&apos;t automate one workflow.</span>
                </div>
                <div>
                  <span className="text-foreground/60 font-medium block mb-1">Traditional automation project</span>
                  <span className="text-foreground/30 font-light">€100-300K budget. 6-12 months. External consulting firm.</span>
                </div>
                <div>
                  <span className="text-foreground/60 font-medium block mb-1">Hiring another employee</span>
                  <span className="text-foreground/30 font-light">€60-90K/year loaded cost. Still does the same work manually.</span>
                </div>
              </div>
            </div>
          </ScrollReveal>
      ...
      <section className="py-32 w-full relative border-t border-b border-white/[0.02] bg-card/[0.2] flex justify-center mesh-subtle">
        <div className="max-w-[1000px] w-full px-6 text-center">
          <ScrollReveal>
            ...
            <p className="text-base text-foreground/50 max-w-2xl mx-auto leading-relaxed font-light mb-8">
