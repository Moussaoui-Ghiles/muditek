...
const COMPARISON = [
  ...
  { category: "Community layer", mudikit: "None inside the product. Public discussion is the Muditek newsletter (5,000+ operators) and LinkedIn (35K).", circle: "Built-in. Spaces, threads, direct messages, events, member directory, and live calls. Community is the core feature." },
