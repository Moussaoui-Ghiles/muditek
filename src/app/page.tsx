            ...
            <ScrollReveal delay={100}>
              <div className="group relative h-[560px] border border-white/[0.08] bg-card/[0.4] hover:bg-card/[0.6] backdrop-blur-md p-10 flex flex-col justify-between overflow-hidden transition-all duration-700 card-lift">
                ...
                <div className="relative z-10 pt-6 border-t border-white/[0.08]">
                   ...
                   <p className="text-xs text-primary/80 mb-4">40-hour guarantee or we reconfigure free</p>
            ...
            <ScrollReveal delay={200}>
               <div className="group relative h-[560px] border border-white/[0.08] bg-card/[0.4] hover:bg-card/[0.6] backdrop-blur-md p-10 flex flex-col justify-between overflow-hidden transition-all duration-700 card-lift">
                ...
                <div className="relative z-10 pt-6 border-t border-white/[0.08]">
                   ...
                   <p className="text-xs text-emerald-400/80 mb-4">&euro;50K in leaks found or you pay nothing</p>
            ...
            <ScrollReveal delay={300}>
               <div className="group relative h-[560px] border border-white/[0.08] bg-card/[0.4] hover:bg-card/[0.6] backdrop-blur-md p-10 flex flex-col justify-between overflow-hidden transition-all duration-700 card-lift">
                ...
                <div className="relative z-10">
                   ...
                   <p className="text-base text-foreground/80 leading-relaxed">
                     48% of investment firms lost a client during onboarding last year. A single KYC review costs $2,598 and takes 95 days. Over half of fund failures come from operational breakdowns, not bad investments. We built the system that fixes all of it, in production for a merchant bank.
                   </p>
                </div>
                ...
                <div className="relative z-10 pt-6 border-t border-white/[0.08]">
                   ...
                   <p className="text-xs text-sky-400/80 mb-4">&euro;150K in waste found or the discovery is free</p>
