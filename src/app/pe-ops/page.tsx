    ...
    <div className="bg-background min-h-[100dvh] text-foreground selection:bg-amber-500/20 flex flex-col items-center">
      ...
      <section className="pt-32 md:pt-44 pb-24 md:pb-32 w-full flex justify-center relative overflow-hidden">
        ...
        <div className="max-w-[1100px] w-full px-6 md:px-12 relative z-10">
          ...
          <ScrollReveal delay={160}>
            <div className="max-w-3xl space-y-6 text-base md:text-lg text-foreground/50 font-light leading-relaxed mb-8">
          ...
          <ScrollReveal delay={240}>
            <p className="text-sm text-foreground/30 italic max-w-3xl mb-14">
          ...
          <ScrollReveal delay={300}>
            <div className="flex flex-col sm:flex-row items-start gap-5">
              ...
              <Link href="#case-study" className="px-8 py-5 border border-white/[0.1] text-foreground text-[11px] font-bold uppercase tracking-[0.2em] rounded-[2px] hover:bg-white/[0.02] transition-colors btn-press">
                View Case Study
              </Link>
            </div>
          </ScrollReveal>
      ...
      <section className="py-24 md:py-32 w-full flex justify-center border-t border-white/[0.02] bg-card/[0.2]">
        <div className="max-w-[1100px] w-full px-6 md:px-12">
          ...
          <ScrollReveal delay={80}>
            <div className="max-w-3xl space-y-4 text-base text-foreground/50 font-light leading-relaxed">
      ...
      <section id="case-study" className="py-32 md:py-48 w-full flex justify-center relative">
        ...
        <div className="max-w-[1100px] w-full px-6 md:px-12 relative z-10">
          ...
          <ScrollReveal delay={300}>
            <p className="text-sm text-foreground/30 italic mt-10 max-w-3xl">
        ...
        <div className="max-w-[1100px] w-full px-6 md:px-12 relative z-10">
          ...
          <ScrollReveal delay={300}>
            <div className="border border-white/[0.05] bg-card/[0.2] p-10 mt-6 rounded-[4px]">
              ...
              <p className="text-[11px] text-foreground/25 mt-8 font-mono tracking-wider">
