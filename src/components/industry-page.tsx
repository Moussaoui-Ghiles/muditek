    ...
    >
      ...
      {config.showMudikit ? (
        <MudikitCta
          ...
          body="The same library I run my own business on. 15+ Claude Code skills, 6 implementation playbooks, the vault template, 20+ outreach templates with A/B variants. New drops every month."
        />
      ) : null}
