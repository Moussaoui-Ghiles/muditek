...
export const INDUSTRIES: Record<IndustrySlug, IndustryConfig> = {
  "private-equity": {
    ...
    metaDescription:
      "Custom operational infrastructure for PE and VC firms in 2026: investor onboarding in 3-5 days, KYC automation, fee computation, document generation. You own the platform.",
    oneLiner:
  ...
  "b2b-saas": {
    ...
    metaDescription:
      "B2B SaaS at €800K-€1.8M ARR loses €80-180K/year to revenue leakage in 2026. We diagnose where the money goes, then build the AI systems that fix it.",
    oneLiner:
  ...
  agencies: {
    ...
    metaDescription:
      "Marketing and dev agencies in 2026 lose 20+ hours/week to manual content, reporting, and ops. The MudiKit operator library + custom builds reclaim margin.",
    oneLiner:
  ...
  telecom: {
    ...
    metaDescription:
      "Regional and national telecom operators in 2026: on-premises AI for SLA reporting, NOC automation, knowledge search, and software operation. No cloud, no per-user fees.",
    oneLiner:
  ...
  fintech: {
    ...
    metaDescription:
      "Fintech and payments firms in 2026: custom operational infrastructure for KYC review queues, automated expiry alerts, reconciliation, and compliance workflows you own.",
    oneLiner:
