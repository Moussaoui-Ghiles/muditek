...
const SKILL_BUNDLE_FILES: Record<string, string[]> = {
  ...
  "google-maps-owner-email-finder": ["SKILL.md", "README.md", "LICENSE", ".gitignore", "examples/example.md", "references/review-rules.md", "scripts/audit-results.mjs", "scripts/collect-website-evidence.mjs", "templates/businesses-input.csv", "templates/owners-output.csv"],
...
const PRESENTATION_BY_SLUG: Record<string, LibraryPresentation> = {
  ...
  "google-maps-owner-email-finder": skillPresentation(
    "google-maps-owner-email-finder",
    "Check public company websites for explicit owner evidence and published emails. Unsupported owners stay unknown, and every retained claim cites the exact company page.",
    ["CSV with company names and websites", "Permission to visit the public websites", "Node.js 20 or newer"],
    ["Saved website evidence", "Cited owner findings", "Published website emails", "Audited owners.csv"],
    ["A reviewed company file", "A person who will check every owner claim"],
  ...
  "google-maps-outbound": playbookPresentation(
    ...
    "Start with a qualified local-business file. Check company websites and cite the exact page behind every owner or email finding.",
    ["Company names and websites", "Reviewed Maps export", "Owner evidence rules"],
    ["Website evidence", "Cited owner findings", "Published website emails", "Unknowns for human review"],
    ["A deduplicated local-business file", "Permission to inspect the public websites"],
  ),
  "10000-cold-email-system": playbookPresentation(
    "10000-cold-email-system",
    "Model the infrastructure, contact supply, funnel assumptions, reply handling, and weekly controls required before approving a 10,000-send day.",
    ["Daily send target", "Provider limits and prices", "List supply", "Funnel assumptions"],
    ["Capacity model", "Infrastructure plan", "Launch checklist", "Weekly operating checklist"],
    ["A reachable market", "Approved sending infrastructure", "Legal and provider review"],
  ),
  ...
  "cold-email-capacity-calculator": toolPresentation(
    "Calculate mailboxes, domains, monthly contact supply, funnel projections, and only the costs you enter. The result is a plan, not a performance claim.",
    ["Daily sends and new sequence starts", "Mailbox and domain limits", "Funnel assumptions", "Optional written costs"],
    ["Required mailboxes and domains", "Monthly sends and contacts", "Projected funnel stages", "Entered monthly cost boundary"],
    ["Your own operating assumptions"],
...
const LIBRARY_MANIFEST_BASE: readonly Omit<LibraryItem, keyof LibraryPresentation>[] = [
  ...
  },
  {
    ...
    summary: "Research local-business owner evidence and public website emails without a paid API.",
    kind: "skill",
    lane: "outbound",
    topic: "local-outbound",
    access: "public",
    ...
    source: "content/skills/google-maps-owner-email-finder",
    relatedAssets: ["/playbooks/google-maps-outbound", "/skills/google-maps-list-builder", "/tools/csv-list-quality-auditor"],
    commercialTarget: OUTBOUND_TARGET,
    redirectTarget: null,
  },
  {
  ...
  },
  {
    ...
    summary: "Turn a qualified local-business file into evidence-backed owner findings and public website emails.",
    kind: "playbook",
    lane: "outbound",
    topic: "local-outbound",
    access: "public",
    ...
    relatedAssets: ["/skills/google-maps-owner-email-finder", "/skills/google-maps-list-builder", "/skills/list-quality-scorecard"],
    commercialTarget: OUTBOUND_TARGET,
    redirectTarget: null,
  },
  {
    ...
    summary: "Calculate and operate the infrastructure, list supply, funnel, reply workflow, and weekly controls behind a 10,000-send day.",
    kind: "playbook",
    lane: "outbound",
    topic: "cold-email",
    access: "public",
    ...
    relatedAssets: ["/tools/cold-email-capacity-calculator", "/tools/outbound-funnel-economics-calculator", "/skills/list-quality-scorecard"],
    commercialTarget: OUTBOUND_TARGET,
    redirectTarget: null,
  },
  {
  ...
  },
  {
    ...
    summary: "Calculate the infrastructure and contact supply required by a cold-email send target.",
    kind: "tool",
    lane: "outbound",
    topic: "cold-email",
    access: "public",
    status: "published",
    updatedAt: "2026-08-28",
    source: "src/lib/cold-email-capacity-calculator.ts",
    relatedAssets: ["/playbooks/10000-cold-email-system", "/tools/outbound-funnel-economics-calculator"],
    commercialTarget: OUTBOUND_TARGET,
    redirectTarget: null,
  },
  {
