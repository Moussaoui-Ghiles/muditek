...
const isPublicRoute = createRouteMatcher([
  ...
  "/api/portal/skills/google-maps-owner-email-finder/download",
  "/api/portal/skills/audience-content-os/download",
  "/api/portal/skills/linkedin-content-writer/download",
  "/api/portal/skills/x-content-writer/download",
  "/api/portal/skills/newsletter/download",
  "/api/portal/skills/tiktok-slideshow-machine/download",
  "/api/portal/skills/lead-magnets/download",
  "/api/portal/billing",
  "/api/indexnow",
]);
